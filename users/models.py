...
class User(AbstractUser):
  ...
  profile_image = models.URLField(max_length=1000, validators=[URLValidator()], default='https://png.pngtree.com/png-clipart/20210129/ourmid/pngtree-default-male-avatar-png-image_2811083.jpg')
